  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(2) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `transactions` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `weekStartDate` TEXT NOT NULL, `category` TEXT NOT NULL, `amount` REAL NOT NULL, `isAdjustment` INTEGER NOT NULL, `createdAt` INTEGER NOT NULL)");
        ...
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '2cc27ab9403cdfb8321b4aad264395c6')");
      }
    ...
    }, "2cc27ab9403cdfb8321b4aad264395c6", "04c62ef141c09608158dcdc8c0c6f37f");
